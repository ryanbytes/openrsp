...
static void assert_gain_plans(void)
{
    ...
    static const mirisdr_rspduo_gain_plan_t uhf_a[] = {
        PLAN(0xc2d1, 0x12df, 0x1224, 0x13fe),
        PLAN(0xe2d1, 0x12df, 0x1224, 0x13fe),
        PLAN(0xe2d1, 0x12df, 0x1224, 0x13fa),
        PLAN(0xe2d1, 0x12df, 0x1224, 0x13b6),
        PLAN(0xc2d1, 0x12df, 0x1226, 0x13fe),
        PLAN(0xe2d1, 0x12df, 0x1226, 0x13fe),
        PLAN(0xe2d1, 0x12df, 0x1226, 0x13fa),
        PLAN(0xe2d1, 0x12df, 0x1226, 0x13f6),
        PLAN(0xe2d1, 0x12df, 0x1226, 0x13ee),
        PLAN(0xf2d1, 0x12df, 0x1226, 0x13ee),
    };
